...
<body id="page-top">
    ...
    <script>
        $(document).ready(function() {
            $('#kode_surat_jalan').change(function() {
                var kodeSuratJalan = $(this).val();
                if (kodeSuratJalan) {
                    $.ajax({
                        url: "{{ route('suratjalan.getdata') }}",
                        type: "POST",
                        data: {
                            _token: "{{ csrf_token() }}",
                        ...
                        success: function(response) {
                            if (response) {
                                ...
                                // Mengambil nama_supplier
                                var namaSupplier = response.nama_supplier;
